...
class ProjectCompiler(
	...
	fun compile(): `in`.kdi.core.di.compiler.core.test.TestCompilationResult {
		compileDependencies()
	...
	private fun KotlinCompilation.Result.toTestCompilationResult() =
        `in`.kdi.core.di.compiler.core.test.TestCompilationResult(
            result = this,
            compiledSource = classpath + compilation.classesDir
        )
}