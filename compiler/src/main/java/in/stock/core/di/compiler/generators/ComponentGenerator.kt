...
import `in`.stock.core.di.compiler.utils.COMPONENT
import `in`.stock.core.di.compiler.utils.addConstructorProperty
import `in`.stock.core.di.compiler.utils.toAnnotationSpec
import `in`.stock.core.di.compiler.utils.toLowerName
