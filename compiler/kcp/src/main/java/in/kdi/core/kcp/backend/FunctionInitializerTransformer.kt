package `in`.kdi.core.kcp.backend

import `in`.kdi.core.kcp.backend.EntryPointIrGenerator.Companion.ASSIGN_INJECTABLE_PROPERTIES
import `in`.kdi.core.kcp.backend.core.Origin
import `in`.kdi.core.kcp.utils.FqNames
import `in`.kdi.core.kcp.utils.irBlockBody
