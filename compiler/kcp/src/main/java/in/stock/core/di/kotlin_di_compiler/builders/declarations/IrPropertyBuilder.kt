...
package `in`.stock.core.di.kotlin_di_compiler.builders.declarations

import `in`.stock.core.di.kotlin_di_compiler.builders.declarations.IrDeclarationBuilder
